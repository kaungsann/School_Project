...
export default function CategoryList({ categories }) {
  ...
  }, [filterValue, hasSearchFilter, categories]);
            ...
            <div className="relative flex justify-start items-center">
              <Dropdown aria-label="action">
                ...
                <DropdownMenu aria-label="Table dropdown menu">
                  <DropdownItem
                    onPress={() => {
                      navigateTo(`/adminpanel/category/view/${category.id}`);
                    }}
                  >
                    View
                  </DropdownItem>
                  <DropdownItem
                    onPress={() => {
                      navigateTo(`/adminpanel/category/edit/${category.id}`);
                    }}
                  >
                    Edit
                  </DropdownItem>
                  <DropdownItem
                    onPress={() => {
                      navigateTo(`/adminpanel/category/delete/${category.id}`);
                    }}
                  >
                    Delete
                  </DropdownItem>
